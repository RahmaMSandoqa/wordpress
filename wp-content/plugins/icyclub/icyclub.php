...
function icycp_activate() {
	...
	if ( 'Busihub' == $theme->name ){

		require_once('inc/busihub/features/customizer.php');
		require_once('inc/busihub/sections/homepage.php');
		require_once('inc/class-alpha-color-control/class-alpha-color-control.php');
...
$theme = wp_get_theme();
if (( 'Consultup' == $theme->name) || ( 'Busiup' == $theme->name) || ( 'Busiway' == $theme->name) || ('Consultup Child' == $theme->name) || ('Consultup Child theme of consultup' == $theme->name) || ('Busihub' == $theme->name)){
