...
if ( ! function_exists( 'icycp_consultup_service' ) ) :
	...
	function icycp_consultup_service() {
		...
		?>
	    <!-- Section Title -->
<section class="consultup-service-section">
	<div class="container">		
...
if ( ! function_exists( 'icycp_consultup_callout' ) ) :
	...
	function icycp_consultup_callout() {
		...
		$callout_btn_txt = get_theme_mod('callout_btn_txt',__('Get Sconsultuprted Now!','consultup'));
		$callout_btn_link = get_theme_mod('callout_btn_link','#');
		...
		?>		
<section class="consultup-callout" style="background-image:url('<?php echo esc_url($callout_background_image);?>');">
<?php } else { ?>
<section class="consultup-callout">
<?php } ?>
...
if ( ! function_exists( 'icycp_consultup_portfolio' ) ) :
	...
	function icycp_consultup_portfolio() {
		...
		?>		
<!-- Portfolio Section -->
<section class="consultup-portfolio consultup-section grey-bg no-padding text-center">
    <div class="container">
      <div class="row">
...
?>
<!--==================== BLOG SECTION ====================-->
  <section id="blog" class="consultup-blog-section">
    <!--overlay-->
    <div class="overlay">
      <!--container-->
      <div class="container">
        ...
        <div class="row">
          <!--col-md-4-->
          <?php $consultup_latest_loop = new WP_Query(array( 'post_type' => 'post', 'posts_per_page' => 3, 'order' => 'DESC','ignore_sticky_posts' => true, ''));
